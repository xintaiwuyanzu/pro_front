            ...
            <el-row :gutter="20" type="flex">
                    ...
                    <el-card shadow="hover">
                        ...
                        <el-tree :data="menuData"
                            ...
                            <div slot-scope="{ node, data }" style="flex: 1;margin: 2px;">
                                <span v-if="organiseId==data.data.id"
                                      style=" color: red;font-family: 等线">{{ data.label }}</span>
                                <span v-if="organiseId!=data.data.id"
                                      style=" color: #409EFF;font-family: 等线">{{ data.label }}</span>
                            </div>
                        </el-tree>
                    </el-card>
                </el-col>
                <el-col :span="19">
                    <el-card shadow="hover">
                        ...
                        <table-render :columns="columns" :data="data" :page="page"
